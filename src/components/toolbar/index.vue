<template>
  <div v-if="options.toolbar?.show" class="umo-toolbar-container">
    ...
    <div class="umo-toolbar-actions" :class="$toolbar.mode">
      ...
      " v-model="statusPopup" :attach="container" trigger="click" placement="bottom-right" @visible-change="(visible: boolean) => (statusPopup = visible)">
        <t-button class="umo-toolbar-actions-button" variant="text" size="small" :class="{ active: statusPopup }">
          <span class="umo-status">
            ...
            <span class="umo-status-saved button-text">
              <span v-if="savedAt" v-text="t('save.savedAtText', { time: timeAgo(savedAt) })"></span>
        ...
        <template #content>
          <div class="umo-document-status-container umo-status">
            ...
            <div class="umo-document-button-container">
              <t-button size="small" @click="saveContent" v-text="t('save.text')"></t-button>
              <t-button size="small" variant="outline" @click="setContentFromCache" v-text="t('save.cache.text')">
              </t-button>
            </div>
          </div>
        </template>
