<template>
  <div ref="wraperRef" class="umo-scrollable-container">
    <div v-if="!hidePrev" class="umo-scrollable-control scrollable-left" @click="scrollLeft">
      <icon name="arrow-down" />
    </div>
    <div ref="contentRef" class="umo-scrollable-content">
      <slot />
    </div>
    <div v-if="!hideNext" class="umo-scrollable-control scrollable-right" @click="scrollRight">
      <icon name="arrow-down" />
    </div>
  </div>
</template>
